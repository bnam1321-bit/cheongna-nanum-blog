            ...
            <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="bg-white rounded-3xl shadow-xl p-8 sm:p-12 mb-12">
                    <div className="prose prose-lg prose-amber max-w-none
                        ...
                        prose-blockquote:bg-stone-50 prose-blockquote:border-l-4 prose-blockquote:border-amber-600 prose-blockquote:py-2 prose-blockquote:px-6 prose-blockquote:rounded-r-lg prose-blockquote:not-italic prose-blockquote:text-stone-700 prose-blockquote:my-8
                    ">
